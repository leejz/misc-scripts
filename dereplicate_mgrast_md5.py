...
This script reads in a tab delimited file of mg-rast sims with md5 keys and extracts the top
md5 hit for each scaffold based on the bit score and outputs a tab delimited table
...
...
   ...
   usage:
   dereplicate_mgrast_md5.py -i mgrast_organism.txt -o output.file
...
if __name__ == '__main__':
    parser = OptionParser(usage = "usage:    dereplicate_mgrast_md5.py -i mgrast_organism.txt -o output.file",                  
    description='Jackson Lee 11/11/14.  This script reads in a tab delimited file of mg-rast sims \
    with md5 keys and extracts the top md5 hit for each scaffold based on the bit score \
